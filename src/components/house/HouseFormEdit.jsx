...
import { useGetUserByIdQuery, useUpdateHouseMutation, useUploadAvatarMutation } from '../../features/api/apiSlice';
import Swal from 'sweetalert2'
import HouseForm from './UserForm';
...
export default function HouseFormEdit(){
        ...
        try {
            ...
            if(response.data.status == "error"){
                Swal.fire({
                    position: "top-end",
                    icon: "error",
                    title: "The house could not be updated, please check the data",
    ...
    const { data: house, isLoading, isError, error } = useGetUserByIdQuery(params.id);
